...
import { dateVars } from "@/misc/paymentTerms";
...
export default function EditInvoice(): JSX.Element {
    ...
    const addDaysToDate = (currDate: string, daysToAdd: number): string => {
        return format(addDays(new Date(currDate), daysToAdd), "yyyy-MM-dd");
    };
