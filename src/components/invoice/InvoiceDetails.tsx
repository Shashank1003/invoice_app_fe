...
import ItemWrapper from "@/components/invoice/ItemWrapper";
    ...
    return (
        <div>
            <div className="mb-[56px] px-[24px]">
                <div className="bg-secondary-bg mt-[32px] flex h-[91px] items-center justify-between rounded-[8px] px-[24px]">
                ...
                <div className="bg-secondary-bg mt-[16px] rounded-[8px] p-[24px] text-[12px] leading-[15px] tracking-[-0.25px]">
                    {invoiceData.id && (
                        <div>
